...
const styles = StyleSheet.create({
  ...
  dropdown: { maxHeight: 200, borderWidth: 1, borderColor: "#E2E8F0", borderRadius: 12, marginTop: 8, backgroundColor: "#fff", overflow: "hidden" },
  ...
  dropdownTrigger: { flexDirection: "row", height: 52, justifyContent: "space-between", alignItems: "center" },
